...
const createCurrentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield newUser.save();
        res.status(201).json(newUser.toObject()); // what toObject() does? >> Converts this document into a plain-old Javascript object.
    }
    catch (error) {
        console.log(error);
...
const updateCurrentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // updating user information by requested information
        user.name = name;
